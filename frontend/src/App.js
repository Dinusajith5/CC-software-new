    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/get-in-touch" element={<div className="pt-20 min-h-screen flex items-center justify-center"><h1 className="text-2xl">Get In Touch - Coming Soon</h1></div>} />
        </Routes>
        <Footer />
        <Toaster />
      </BrowserRouter>
